...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'datadonor', name: 'dataDonor', component: () => import('src/pages/admin/DataDonor.vue') },
      { path: 'formedit/:id', name: 'formEditBarang', component: () => import('pages/admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
